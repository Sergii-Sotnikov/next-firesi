      ...
      <div className={css.container}>
        ...
        >
          <Accordion.Item value="item-1" className={css.item}>
            ...
            <Accordion.Content className={css.content}>
              <p className={css.faqText}>
                Так, абсолютно! Йому не страшний мороз до -15°C ні спека +60°C!
          ...
          <Accordion.Item value="item-2" className={css.item}>
            ...
            <Accordion.Content className={css.content}>
              <p className={css.faqText}>
                Вогнегасник <span className={css.faqTextBold}>FRSE-F2 (обʼєм заряду - 2 л)</span> - оптимальне рішення для
                захисту електромобілів. Завдяки компактним розмірам і
                спеціальній формулі вогнегасної речовини, модель ефективно
                нейтралізує загоряння в електричних системах та акумуляторах, не
                завдаючи шкоди електроніці та не залишаючи агресивних залишків.
              </p>
            </Accordion.Content>
          </Accordion.Item>
